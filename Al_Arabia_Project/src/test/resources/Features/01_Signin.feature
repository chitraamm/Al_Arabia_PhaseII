...
Scenario: Login with valid email address and invalid password without special character
When User enters valid email address
...
Scenario: Login with valid email address and invalid password with short character
When User enters valid email address
...
Scenario: Login without email address and password
