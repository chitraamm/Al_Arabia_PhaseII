...
//		this.signinpage = new Signinpage(driver);
	...
	WebElement New_TicketClick, New_Ticket_display;
	...
	WebElement Ticket_title_select;

	@FindBy(id = "react-select-19-input")
	WebElement Assignee_select;
	...
	WebElement Ticket_create_BB_btn;
	...
	@FindBy(id = "doc_searchQueryInput")
	WebElement ticketSearchedList, Ticketlist;
	...
	WebElement ticket_sort;

	@FindBy(xpath = "(//h6[contains(text(),'Recently Updated')])[1]")
	WebElement tickets_sort_recentlyupdated;

	@FindBy(xpath = "(//h6[contains(text(),'Recently Added')])[2]")
	WebElement tickets_sort_recentlyadded;
	...
	WebElement Ticket_Name_decending;
	...
	WebElement Click_Cleaning_Ticket;
	...
	WebElement Click_non_Cleaning_Ticket;
	...
	@FindBy(xpath = "(//h6[contains(@class,'m-0 fw-normal')][normalize-space()='Download'])[1]")
	  WebElement download_buttn_ticketspage;
	...
	@FindBy(xpath = "//div[@class='modal-header']")
	  WebElement tickets_Download_popup_display;
	...
	@FindBy(xpath = "(//div[normalize-space()='As Excel'])[1]")
	  WebElement tickets_Download_excel;
	...
	@FindBy(xpath = "//div[normalize-space()='As PDF']")
	  WebElement tickets_Download_pdf;
	...
	@FindBy(xpath = "(//*[name()='svg'][contains(@stroke,'currentColor')])[12]")
	  WebElement ticket_Download_popupclose;
	...
	@FindBy(xpath = "(//h5[normalize-space()='All Tickets'])[1]")
	  WebElement ticket_Edit_page_display;
	...
	@FindBy(xpath = "//*[@id=\"root\"]/div[2]/div[1]/div[2]/div/div[2]/div[1]/div[4]/div/table/tbody/tr[1]/td[8]/div[2]/div/img")
	  WebElement delete_click_ticket_;
	...
	@FindBy(xpath = "//h6[normalize-space()='Yes, delete it.']")
	  WebElement ticket_delete_confirm_bttn;
	...
	@FindBy(xpath = "//h6[normalize-space()='Yes, update it.']")
	  WebElement ticket_update_confirm_yes_button;
	...
	@FindBy(xpath = "//span[normalize-space()='Activity Feed']")
	  WebElement click_Activity_feed;
	@FindBy(xpath = "//span[@class='edit_link_routes active']")
	  WebElement view_ticket_tab;
	...
	@FindBy(xpath = "//input[@accept='image/png, image/gif, image/jpeg']")
	  ...
	  WebElement Click_upload_photos;
	...
	@FindBy(xpath = "//input[@class='inputfilevideo']")
	  WebElement click_upload_videos;
	...
	@FindBy(xpath = "//span[contains(@class,'fw-semibold')]")
	  WebElement update_audio_button;
	@FindBy(xpath = "//div[@class=' d-flex justify-content-end']//img")
	  WebElement record_close_button;
	...
	@FindBy(xpath = "//div[contains(@class,'attachment position-relative')]//img[contains(@class,'position-absolute x_close')]")
	  WebElement click_uploaded_photo_close;
	...
	@FindBy(xpath = "//h6[normalize-space()='Yes, remove it.']")
	  WebElement click_uploaded_photo_close_confirm;
	...
	@FindBy(xpath = "//div[@class=' d-flex py-5 flex-wrap gap-4']")
	  WebElement attach_medias;
	@FindBy(xpath = "//img[@class=' position-absolute x_close']")
	  WebElement click_uploaded_video_close;
	...
	@FindBy(xpath = "//h6[normalize-space()='Yes, remove it.']")
	  WebElement click_uploaded_video_close_confirm;
	...
	@FindBy(xpath = "//h6[normalize-space()='Verify']")
	  WebElement click_verify_button;
	...
	@FindBy(xpath = "(//h6[normalize-space()='Yes, verify it.'])[1]")
	  WebElement click_verify_confirm_button;
	...
	@FindBy(xpath = "//h6[normalize-space()='Reassign']")
	  WebElement click_reassign_button;
	...
	@FindBy(xpath = "//h6[normalize-space()='Yes, reassign it.']")
	 WebElement click_reassign_confirm_button;
	...
	@FindBy(xpath = "//h6[normalize-space()='Approve']")
	 WebElement click_approve_button;
	...
	@FindBy(xpath = "//h6[normalize-space()='Yes, approve it.']")
	  WebElement click_approve_confirm_button;
	...
	@FindBy(xpath = "//button[@id='Reject']")
	  WebElement click_reject_button;
	...
	@FindBy(xpath = "//h6[normalize-space()='Yes, reject it.']")
	  WebElement click_reject_confirm_button;
	...
	@FindBy(id = "Start Conversation")
	  WebElement click_start_conversation;
	...
	@FindBy(xpath = "//div[contains(text(),'Showing')]")
	  WebElement second_page_display;
	...
	@FindBy(xpath = "//*[@id=\"root\"]/div/div[2]/div/div[2]/div[1]/div[4]/div[2]/div[1]")
	  WebElement click_previous_page;
	...
	@FindBy(xpath = "//h6[normalize-space()='Reset Form']")
	  WebElement ticket_reset_button;
	...
	@FindBy(xpath = "//h6[normalize-space()='Yes, reset it.']")
	  WebElement ticket_reset_confirm_yes_button;
	...
	@FindBy(xpath = "//*[@id=\"root\"]/div/div[2]/div/div[2]/div[2]/div[2]/div/div[1]/h6")
	  WebElement tickets_reassign_tickmark_display;
